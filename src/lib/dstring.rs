...
unsafe extern "C" fn dstring_ensure_space(mut ds: *mut DString, mut size: libc::c_int) -> Bool {
...
#[no_mangle]
pub unsafe extern "C" fn dstring_copy(mut dst: *mut DString, mut src: *const DString) -> Bool {
...
#[no_mangle]
pub unsafe extern "C" fn dstring_append(mut dst: *mut DString, mut src: *const DString) -> Bool {
