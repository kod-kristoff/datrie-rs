...
fn test_walk() -> anyhow::Result<()> {
    unsafe {
        ...
        assert_eq!(
            trie_state_is_walkable(s, 'p' as AlphaChar),
            DA_TRUE,
        ...
        //     }
        assert_eq!(
            trie_state_walk(s, 'p' as AlphaChar),
            DA_TRUE,
        ...
        let n = trie_state_walkable_chars(s, walkables.as_mut_ptr(), ALPHABET_SIZE as i32);
        ...
        let t = trie_state_clone(s);
        assert!(!t.is_null(), "Failed to clone trie state\n");
        //         goto err_TrieState::s_created;
        //     }
        assert_eq!(
            trie_state_walk(t, 'o' as AlphaChar),
            DA_TRUE,
        ...
        assert_eq!(
            trie_state_walk(t, 'l' as AlphaChar),
            DA_TRUE,
        ...
        let data = trie_state_get_data(t);
        ...
        assert_eq!(
            trie_state_walk(s, 'r' as AlphaChar),
            DA_TRUE,
        ...
        trie_state_copy(t, s);
        assert_eq!(
            trie_state_walk(t, 'i' as AlphaChar),
            DA_TRUE,
        ...
        assert_eq!(
            trie_state_walk(t, 'z' as AlphaChar),
            DA_TRUE,
        ...
        assert_eq!(
            trie_state_walk(t, 'e' as AlphaChar),
            DA_TRUE,
        ...
        let u = trie_state_clone(s);
        assert!(!u.is_null(), "Failed to clone trie state\n");
        //         goto err_TrieState::t_created;
        //     }
        assert_eq!(
            trie_state_walk(u, 'e' as AlphaChar),
            DA_TRUE,
        ...
        is_failed = false;
        let n = trie_state_walkable_chars(u, walkables.as_mut_ptr(), ALPHABET_SIZE as i32);
        ...
        trie_state_copy(t, u);
        assert_eq!(
            trie_state_walk(t, 'v' as AlphaChar),
            DA_TRUE,
        ...
        assert_eq!(
            trie_state_walk(t, 'w' as AlphaChar),
            DA_TRUE,
        ...
        trie_state_copy(t, u);
        assert_eq!(
            trie_state_walk(t, 'p' as AlphaChar),
            DA_TRUE,
        ...
        assert_eq!(
            trie_state_walk(t, 'a' as AlphaChar),
            DA_TRUE,
        ...
        assert_eq!(
            trie_state_walk(t, 'r' as AlphaChar),
            DA_TRUE,
        ...
        assert_eq!(
            trie_state_walk(s, 'o' as AlphaChar),
            DA_TRUE,
        ...
        trie_state_copy(t, s);
        assert_eq!(
            trie_state_walk(t, 'd' as AlphaChar),
            DA_TRUE,
        ...
        assert_eq!(
            trie_state_walk(t, 'u' as AlphaChar),
            DA_TRUE,
        ...
        assert_eq!(
            trie_state_walk(t, 'c' as AlphaChar),
            DA_TRUE,
        ...
        assert_eq!(
            trie_state_walk(s, 'g' as AlphaChar),
            DA_TRUE,
        ...
        assert_eq!(
            trie_state_walk(s, 'e' as AlphaChar),
            DA_TRUE,
        ...
        assert_eq!(
            trie_state_walk(s, 's' as AlphaChar),
            DA_TRUE,
        ...
        let data = trie_state_get_data(s);
